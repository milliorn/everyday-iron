          ...
          <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
            <div>
              ...
              <p className="mt-4 text-lg text-gray-300 xl:text-xl 2xl:text-3xl">
                ...
                Federation Gym. Sanctioned by World Powerlifting Congress, it’s
                not just a gym but an environment for people of all walks of
                life. Owned and Operated by U.S. ARMY Veteran. Ready to start
                your fitness journey? Scroll down to learn more!
              </p>
              <a
