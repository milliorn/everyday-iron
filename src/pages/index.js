        ...
        <section className="page-section" id="services">
          <div className="container">
            <h2 className="text-center mt-0">
              Rhinos Athletic Performance Is All About Change!
            </h2>
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    We have experienced coaches who can get you to meet your
                    goals in competition or hobby.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    Get into the best shape of your life. Our trainers here can
              ...
              <div className="col-lg-4 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    Whether its therapy or to turn your life around we will be
              ...
              <div className="col-lg-4 col-sm-6">
                ...
                >
                  ...
                  <div className="portfolio-box-caption">
                    <div className="project-category text-white-50">Squat</div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center text-secondary">
                <h2 className="mt-0">
                  Owned and Operated by U.S. ARMY Veteran
                </h2>
                <hr className="divider my-4" />
                <p className="text-white mb-5">
                  Ready to start your fitness journey with us? Give us a call or
            ...
            <div className="row">
              <div className="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                ...
                <a className="text-bold" href="tel:+1-559-577-8679">
                  +1 (559) 577-8679
                </a>
              </div>
          ...
          <div className="container">
            <div className="text-center text-bold text-white">
              ...
              <div className="text-center p-3">
                ...
                <a
                  className="btn btn-dark btn-social mx-2"
                  href="https://goo.gl/maps/KDzH3bjZMYFmi7HN9"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Maps"
                >
